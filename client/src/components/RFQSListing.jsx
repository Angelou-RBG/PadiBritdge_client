        ...
        <form className="form-shell" onSubmit={handleAddRecordSubmit}>
          ...
          <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'flex-end' }}>
            <div style={{ flex: 2 }}>
              ...
              <select value={tempVariety} onChange={e => setTempVariety(e.target.value)} disabled={isSubmittingAdd} style={{ padding: '0.75rem', fontSize: '1rem', width: '100%', borderRadius: '6px', border: '1px solid #cbd5e1', backgroundColor: '#fff' }}>
            ...
            <div style={{ width: '120px' }}>
              ...
              <input type="number" min="1" max={maxAllowed !== '' ? maxAllowed : undefined} step="1" value={tempQuantity} onChange={e => setTempQuantity(e.target.value)} disabled={isSubmittingAdd} style={{ padding: '0.75rem', fontSize: '1rem', width: '100%', borderRadius: '6px', border: '1px solid #cbd5e1', backgroundColor: '#fff' }} />
              </div>
